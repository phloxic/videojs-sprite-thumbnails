...
```html
<script src="https://unpkg.com/videojs-sprite-thumbnails@2.2.0/dist/videojs-sprite-thumbnails.min.js"></script>
```
...
`columns` | Integer | [&#10004;](#migrating-from-v21x){#columns} | `0` | Number of thumbnail columns per image. Set both `columns` and `rows` to `1` for [individual thumbnails](#individual-thumbnails).
